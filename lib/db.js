...
export async function ensureSchema() {
  ...
  `;
  // Safety nets: if the table existed before these columns, bring it in line.
  await sql`ALTER TABLE topics ADD COLUMN IF NOT EXISTS description TEXT`;
  await sql`ALTER TABLE topics ADD COLUMN IF NOT EXISTS intervals JSONB`;
  await sql`ALTER TABLE topics ADD COLUMN IF NOT EXISTS recurring BOOLEAN NOT NULL DEFAULT FALSE`;
  await sql`ALTER TABLE topics ADD COLUMN IF NOT EXISTS tags JSONB`;
  await sql`
